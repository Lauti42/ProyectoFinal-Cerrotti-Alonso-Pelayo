...
from .views import DesarrolladorCreate, DesarrolladorDetail, DesarrolladorList, DesarrolladorUpdate, Desarrolladordelete, GeneroCreate, GeneroDetail, GeneroList, GeneroUpdate, Generodelete, JuegosCreate, JuegosDetail, JuegosList, JuegosUpdate, Juegosdelete, PlataformasCreate, PlataformasDetail, PlataformasList, PlataformasUpdate, Plataformasdelete
